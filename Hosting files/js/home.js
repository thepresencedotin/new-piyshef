...
function goSingleCaseStudiesPage(id) {
    location.replace("case-study?id=" + id)
}
    ...
    firebase.firestore().collection("journals").orderBy("priority", "asc").limit(4).onSnapshot(function (snapshot) {
        ...
        <div class="inner-box">
          ...
          <div class="lower-content">
            ...
            <h3><a href="journals">${element.data().title.slice(0, 20)}</a></h3>
            <a href="journals" class="read-more">Read More</a>
          </div>
        </div>
        <br><br>
      </div> `
            ...
            image += `
    <a href="journals"><img src="${element.data().imgUrl}" alt="" /></a>
    `
